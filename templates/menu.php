  ...
  <header class="et-header">
        <div class="container px-xl-0">
            <nav class="navbar navbar-expand-lg navbar-dark et-header">
                ...
                <div class="collapse navbar-collapse" id="mainMenu">
                    ...
                    <ul class="navbar-nav mr-auto text-uppercase et-menu">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="<?php echo SITE_URL; ?>/?type=news" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Newsy</a>
                            <div class="dropdown-menu et-menu-dropdown" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="<?php echo SITE_URL; ?>/?type=news">Newsy</a>
                                <a class="dropdown-item" href="<?php echo SITE_URL; ?>/?type=news">Artykuły</a>
                                <a class="dropdown-item" href="<?php echo SITE_URL; ?>/?type=news">Wywiady</a>
                                <a class="dropdown-item" href="<?php echo SITE_URL; ?>/?type=news">Felietony</a>
                            </div>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo SITE_URL; ?>/?type=mem">Memy</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo SITE_URL; ?>/?type=video">Video</a>
                        </li>
                ...
                <!-- Login -->
                <a class="text-uppercase et-login" href="<?php echo SITE_URL; ?>/panel.php"><i class="far fa-user mr-3 et-login-icon"></i>Zaloguj się</a>
